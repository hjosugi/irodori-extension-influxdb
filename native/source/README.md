...
|---|---|---|---|
| `desktop-db-adapter` | `apps/desktop/src-tauri/src/db/influx.rs` | `native/source/irodori-table/apps/desktop/src-tauri/src/db/influx.rs` | `f872ddef744c7ad5e9f4cee85cfba9bb364a1e81e04c1ff7d23300e1e410717c` |
...
| `desktop-db-contract` | `apps/desktop/src-tauri/src/db/profile.rs` | `native/source/irodori-table/apps/desktop/src-tauri/src/db/profile.rs` | `cd29058f740ae378868eda3bc3e7eaee08f3a285b77a9603c5b5d703ea933bb3` |
